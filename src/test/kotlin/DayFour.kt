...
class DayFour {
    ...
    fun name() {
        ...
        val board1 = Board(board1, listOf { fail { "unexpected win for board1" } })
        val board2 = Board(board2, listOf { fail { "unexpected win for board2" } })
        val board3 = Board(board3, listOf { winnerFound = true; assertThat(it, equalTo(4512)); })
